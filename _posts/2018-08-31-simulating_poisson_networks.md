...
- The number of points of $$\phi$$ in $$B$$ (denoted by $$N(B)$$) are Poisson distributed with rate $$\lambda \mid B \mid$$, where $$\lambda$$ is the intensity of the HPPP and $$\mid B \mid$$ is the are of $$B$$.
